...
const profile = {
  ...
  summary: 'Pinnacle Blooms Network is the child-development service brand of Bharath Healthcare Laboratories Private Limited, an Indian company incorporated in 2016. Its published approach connects developmental ability measurement, individual planning, integrated intervention, parent-guided everyday practice and progress review. The company holds an MD-5 manufacturing licence naming PinnacleAI® GPT-OS v1.0.0, Class B non-diagnostic developmental-support software. This profile brings together corporate identity records, the software licence, quality-system documentation, dated institutional counts, facility-register observations and research publications. It distinguishes company descriptions, independent practitioner findings and clinical research, so readers can cite each statement with its source, date and scope.',
  facts: [
    {
