...
const css=['fonts/fonts.css','styles.css','upgrade.css','evidence-design.css','impact.css','semantic.css','world.css','share.css','reader.css','experience.css','topics.css','citations.css','presentation.css'];
...
for(const file of fs.readdirSync(dist,{recursive:true}).filter(p=>p.endsWith('.html'))){
 ...
 html=html.replace(/<link rel="stylesheet" href="\/(styles|upgrade|evidence-design|impact|semantic|world|share|reader|experience)\.css">/g,()=>{if(added)return '';added=true;return `<link rel="stylesheet" href="${bundle}">`;});
