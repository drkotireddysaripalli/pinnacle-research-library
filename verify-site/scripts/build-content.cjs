...
const worldHero=`<section class="intro world-intro wrap" aria-labelledby="page-title"><div class="world-intro-copy"><p class="eyebrow">PINNACLEAI® · UNDERSTAND THE JOURNEY. VERIFY THE EVIDENCE.</p><h1 id="page-title">Your child’s path toward<br><em>self-sufficiency<br>and mainstream life.</em></h1><p class="hero-way-forward">PinnacleAI® — the way forward.</p><p class="intro-purpose">Because every child deserves a wonderful life.</p><p class="intro-copy">Understand abilities. Agree a personal plan. Connect guided practice, family feedback and professional review toward growing independence and participation in everyday life.</p><div class="hero-actions"><a class="primary-link" href="#experience">${icon('network')}See how it works</a><a class="outline-link" href="#proof-map">${icon('file-search')}Verify the evidence</a></div><div class="hero-credentials"><a href="/evidence/records/md5.html">MD-5 · Class B SaMD</a><a href="/evidence/records/bis.html">BIS licence & scope</a></div><p class="hero-scope">Non-diagnostic developmental support · Ages 0–12 · Individual outcomes vary.</p><div class="hero-share-slot"></div></div>${world.hero}</section>${experience.audience}${experience.tour}${experience.reports}${experience.proof}`;
