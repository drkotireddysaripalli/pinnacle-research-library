...
write('evidence/evidence.json',JSON.stringify({title:'Pinnacle evidence register',canonical:origin+'/',sourceReviewed:sourceDate,conclusionsUpdated:date,audience:'Private review edition',contact:{name:'Gokul Rao',email:'care@pinnacleblooms.org',telephone:'+919100181181'},reviewBoundary:'Source inspection is separate from current issuer verification. Human page approval has not been recorded.',records:exportRecords},null,2));
const intro=`# Pinnacle Verification Centre\n\n> Source-led evidence for Pinnacle Blooms Network and Bharath Healthcare Laboratories Private Limited.\n\nSource review: ${data.reviewed}. Selected originals and review conclusions rechecked: ${data.updated}. This site summarizes documentary evidence and is not a regulator’s certification service. Preserve the review status and scope limits when citing a record. A protocol is not completed validation; a management-system certificate does not guarantee a child’s outcome. Human page approval has not been recorded.\n\nContact: Gokul Rao · care@pinnacleblooms.org · +91 9100 181 181.\n\n`;
