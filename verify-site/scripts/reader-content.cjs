...
const groups=[
 ...
 ['accountability','Review & accountability','Review conclusions, methods, updates and corrections.',['review-summary','review','method']]
];
module.exports=function organize(body,teaser=''){
 ...
 const intro=`<div class="reader-guide wrap" id="reader-guide"><p class="eyebrow">YOUR QUESTIONS. YOUR PACE.</p><h2>Go deeper, at your pace.</h2><p>Choose a topic for the full explanation, source documents and review notes.</p></div>`;
 const edits=selected.map(n=>({start:n.start,end:n.close,value:''}));
 edits.push({start:anchor,end:anchor,value:intro+nav+chapters+teaser});
