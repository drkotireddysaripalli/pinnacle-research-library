...
function organize(body,teaser='',{icon,e,chapterExtras={}}){
 ...
 const bands=[
  {id:'journey',title:'A plan for the life you picture for your child.',text:'From asking for help to joining a classroom, the goals are part of everyday life. See how a personal plan connects therapy, practice at home and regular progress review.',range:[0,3],icon:'users',image:'care-participation',alt:'Conceptual scenes of professional support, practice at home and classroom participation.',next:'evidence',nextLabel:'Explore the evidence',bridge:'Get to know the people, licences and records behind the plan.'},
