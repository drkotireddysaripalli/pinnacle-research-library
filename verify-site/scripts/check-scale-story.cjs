...
assert(html.includes('</section><section class="scale-story wrap"'));
...
console.log(JSON.stringify({pass:true,immediatelyAfterHero:true,countsAndAttribution:true,sourceLinks:true,structuredData:true,sharing:true}));
