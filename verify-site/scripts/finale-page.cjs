...
module.exports=({e,origin,date,organization,website,brand,head,footer,write})=>{
 ...
 const desc='See how a child’s life abilities guide PinnacleAI® goals, a 40-minute session and review. Explore the 18-part story, research, MD-5, BIS and source records.';
