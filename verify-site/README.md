...
## Visual mobile redesign · 19 September 2026
...
### Historical challenge and decision order · 22 September 2026

The homepage introduction and full reader now lead with “The outcome belongs at the beginning.” A sourced historical challenge precedes the two decision paths, the Moon analogy, everyday ability examples and the supplied session walkthrough. The monograph’s 160-year thesis is attributed to its author; WHO/UNICEF’s 2023 account of fragmented systems is separate independent context. A source disclosure includes the 2001 ICF and 2006 CRPD milestones. No claim of universal provider failure or comparative clinical superiority is inferred from those sources.

The same argument, citations and scope are exported as text and JSON and included in llms-full.txt. Homepage comparisons and evidence metrics stack on narrow phones. Browser verification covers 320px, 390px and 1280px, including source disclosures and example tabs; no additional image or script dependencies were added.

### Seven-image opening · 22 September 2026

The opening now follows the requested Moon, Home, Child, Car, Child, Home, Child sequence. Large imagery sits beside the copy on desktop and above it on phones. Native scroll snapping supports swiping, keyboard arrows, previous/next buttons and seven direct links, without autoplay. Every slide has a canonical WhatsApp share link and static crawlable text. The historical issues and PinnacleAI® philosophy are separate blocks after the slider. The purpose is the child's self-sufficient, mainstream life; measurement is one tool serving that purpose. Both the homepage and full reader use the same authored opening and text/JSON exports.

The new home illustration was generated using built-in image generation and exported as home-600.webp and home-1200.webp. Prompt: a text-free photorealistic Indian family home with teal entrance, mother and child, sunlit rooms, white organic edges and a subtle multicolour developmental pathway. Existing Moon, car and child illustrations are reused. Navigation code is dependency-free and fingerprinted; images are responsive and lazy-loaded. Original report presentation and dated evidence remain unchanged.


## National Autism Helpline reference · 24 September 2026

The shared reference footer on all 84 Verify pages now links to Pinnacle’s National Autism Helpline for free guidance, 24/7. Both reading indexes include the service and its dated facts. The source comparison confirms no other HTML content changed; the 36 records, four Dataset licences and FSC/story remain intact. Worker version72, release531e720409221199, preserves all existing routes, Worker-first assets and three bindings. The separate helpline source is in `../helpline-site/` in the public repository. This is an owned-site discovery improvement, not an independent endorsement or earned external backlink.
